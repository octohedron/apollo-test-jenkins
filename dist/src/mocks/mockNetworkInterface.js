...
var MockNetworkInterface = (function () {
    ...
    MockNetworkInterface.prototype.mutate = function (request) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var parsedRequest = {
            ...
            var responses = _this.mockedResponsesByKey[key];
            if (!responses || responses.length === 0) {
                throw new Error("No more mocked responses for the mutation: " + printer_1.print(parsedRequest.query) + ", variables: " + JSON.stringify(request.variables));
            }
            var _a = responses.shift(), result = _a.result, error = _a.error, delay = _a.delay;
            if (!result && !error) {
                throw new Error("Mocked response should contain either result or error: " + key);
...
var MockSubscriptionNetworkInterface = (function (_super) {
    ...
    function MockSubscriptionNetworkInterface(mockedSubscriptions, mockedResponses) {
        var _this = this;
        _super.call(this, mockedResponses);
        this.mockedSubscriptionsByKey = {};
        this.mockedSubscriptionsById = {};
        this.handlersById = {};
        this.subId = 0;
